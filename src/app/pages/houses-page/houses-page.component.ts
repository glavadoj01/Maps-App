...
// Se suele hacer en un archivo aparte, pero para este ejemplo lo dejamos aquí
...
export class HousesPageComponent {
  // Lo mismo, suele estar en fichero o API externa, pero para este ejemplo lo dejamos aquí
